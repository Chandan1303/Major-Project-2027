...
export function publicUser(user) { return { id: user.id, name: user.name, email: user.email, role: user.role || 'user', phone: user.phone || null, location: user.location || null, createdAt: user.created_at }; }
